...
const signIn = () => {
    ...
    return (<div className="container">
            ...
            <form method="post" className="form-group p-4 w-75" onSubmit={signIn}>
                {notification && <div>{notification}</div>}
                <div className="form-group py-2">
                    <label className="form-check-label">Email</label>
                    <input className="form-control" type="text" name="email" value={email} onChange={(e) => setEmail(e.target.value)} id="email"/>
                </div>
                {/* {validation.email && (
            <div className="alert alert-danger">
                ...
                <div className="form-group py-2">
                    ...
                    <input className="form-control" type="password" name="password" value={password} onChange={(e) => setPassword(e.target.value)} id="password" autoComplete="false"/>
                </div>
                {/* {validation.password && (
            <div className="alert alert-danger">
