...
const signIn = () => {
    ...
    return (
        <div className="d-flex flex-column">
            <div className="d-flex flex-row mb-5 p-2">
            ...
            <div className="d-flex flex-column justify-content-center align-items-center h-100 mt-5">
                <div className="d-flex flex-row w-25">
                    <p className="base-second-font-family text-nowrap pt-5 align-text-bottom fw-bold fs-1">DR. LUQVI</p>
                    <h2 className="base-second-font-family text-wrap text-end fs-3 ms-4">Data Repository for Linking Quality Vocational
                        Cooperation</h2>
                </div>
                <div className="card w-25 background-purple">
